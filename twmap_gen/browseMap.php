...
for($j=$y;$j>$y-$sy;$j--) {
	echo "<tr>";
	for($i=$x;$i<$x+$sx;$i++) {
		printf('<td style="background: url(\'?type=image&x=%d&y=%d&ph=%d\') center no-repeat; width: 315px; height: 315px;">%s</td>' . "\n",
			$i,$j,$ph , "<span class='gridx'>$i</span>,<span class='gridy'>$j</span></td>");
		//
	}
}
