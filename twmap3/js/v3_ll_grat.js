...
var Graticule = (function() {
  ...
  _.prototype.decToLonSex = function(d) {
    ...
    _.prototype.draw = function() {
        ...
        // labels on second column to avoid peripheral controls <-- change 1
				// happyman
        var y = latLngToPixel(this, b + 1 * dLat, l).y + 2;
        ...
        var crosslat = b + 2 * dLat;
				// labels on second row to avoid controls <-- change to 1 happyman
        var x = latLngToPixel(this, b, l + 1 * dLng).x + 3;
