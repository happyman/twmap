...
function GeolocationMarker(opt_map, opt_markerOpts, opt_circleOpts) {
  ...
  var markerOpts = {
    ...
    'flat': true,
    'icon': {
        'url': '//google-maps-utility-library-v3.googlecode.com/svn/trunk/geolocationmarker/images/gpsloc.png',
...
GeolocationMarker.prototype.setMap = function(map) {
  ...
  this.notify('map');
  if (map) {
    console.log("call watch Position");
    this.watchPosition_();
  } else {
    console.log("call watch Position no map");
